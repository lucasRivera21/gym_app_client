    ...
    return (
        <>
            ...
            <div className='flex items-center  border-violet rounded-md border pr-[18px] focus-within:ring-1 focus-within:ring-violet  mt-2'>
                <input type={showPassword ? 'text' : 'password'} name={label} {...register("password")} id={label} placeholder='Ingrese su contraseña' className='p-3  w-full outline-none rounded-md ' />
